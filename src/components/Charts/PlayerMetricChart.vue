...
const getData = async () => {
    await ChartDataServices.getPlayerChartData(props.aliasId, props.metricId)
    .then((response) => {
...
<template>
   <MetricChart :data-loaded="dataLoaded" :data-points="data" :metric-name="metricName" :error-msg="errorMsg"/>
</template>